...
FROM Employees WHERE Salary = 25000 OR Salary =14000 OR Salary = 12500
OR Salary = 23600
...
ORDER BY Salary DESC,
 ...
 (
 SELECT CONCAT_WS (' ', FirstName,ISNULL(MiddleName, ''),LastName) AS 'Full Name',
 ...
 --21
 SELECT * FROM Departments
 --EngineeringID(1), Tool Design ID(2), Marketing ID(4), Information Service ID(11)
 BEGIN TRANSACTION
 UPDATE Employees
 SET Salary *=1.12
